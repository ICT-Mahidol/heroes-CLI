...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
        add your code here to go through all the heroes and villains in
        the supHumans list and print out their weapon using getWeapon() method.
        */
        for (Superhuman s: supHumans) {
            System.out.println(s.getName() + ": " + s.getWeapon());
        }
        ...
        */
        ...
        System.out.println(spidey.getFriends());
        System.out.println(ned.getFriends());
    }
}
